...
class QQHelper {
        ...
        if (mIsLoginOut) {
            if (mTencent != null) {
                ...
                if (!TextUtils.isEmpty(PreferencesUtils.getString(mActivityRef.get(),
                        com.sdk.ltgame.ltnet.base.Constants.QQ_ACCESS_TOKEN)) &&
                        !TextUtils.isEmpty(PreferencesUtils.getString(mActivityRef.get(),
                                com.sdk.ltgame.ltnet.base.Constants.QQ_OPEN_ID)) &&
                        PreferencesUtils.getLong(mActivityRef.get(),
                                com.sdk.ltgame.ltnet.base.Constants.QQ_TOKEN_TIMEOUT,
                                0) != 0) {
    ...
    private void saveData(String accessToken, String openID, long time) {
        PreferencesUtils.putString(mActivityRef.get(),
                com.sdk.ltgame.ltnet.base.Constants.QQ_ACCESS_TOKEN, accessToken);
        PreferencesUtils.putString(mActivityRef.get(),
                com.sdk.ltgame.ltnet.base.Constants.QQ_OPEN_ID, openID);
        PreferencesUtils.putLong(mActivityRef.get(),
                com.sdk.ltgame.ltnet.base.Constants.QQ_TOKEN_TIMEOUT, time);
    }
